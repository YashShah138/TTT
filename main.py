...
def player_choice(board, name, choice):
    ...
    while position not in [1,2,3,4,5,6,7,8,9] or not space_check(board, position):
        position = int(input(f"{name} ({choice}), Choose your next position: (1-9): "))
...
while True:
    ...
    if(mode == 2):
        ent = input("This is going to be fast! Press Enter for the battle to begin! \n")
        play_game = 1
    else:
        play_game = play()   
...
#####################################
        ...
        if turn == p1_name:
            ...
            if mode != 2:
                ...
                print(f"{p1_name} ({p1_choice}) have chosen position: {position}")
...
#####################################
        # Player_2            
            ...
            if(mode == 1):
                ...
                print(f"{p2_name} ({p2_choice}) have chosen position: {position}")
            ...
            if win_check(theBoard, p2_choice):
                ...
                print("\n************************************************\n")
                if(mode):
                    print(f"CONGRATULATIONS {p2_name}! You've won the Game!")
                else:
